...
<body>
    <div id="app">  
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <ul class="navbar-nav text-uppercase ms-auto me-4">
                        <li class="nav-item active">
                            <a class="nav-link" href="providerHome">Home</a>
                        </li>
                        @if(Session::has('seeker'))
                        <div class="dropdown me-5">
                            <button class="btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                {{Session::get('seeker')['firstname']}}
                            </button>
                        ...
                        @elseif(Session::has('companies'))
                        <div class="dropdown">
                            <button class="btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                {{Session::get('companies')['signup_compname']}}
                            </button>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="job-form">Post a Job</a></li>
                                <li><a class="dropdown-item" href="#">Company Details</a></li>
                                <li><a class="dropdown-item" href="#">Applied Candidates</a></li>
                                <li><a class="dropdown-item" href="logout">Logout</a></li>
                            </ul>
                        </div>
                        @elseif(Session::has('employer'))
                        <div class="dropdown">
                            <button class="btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                {{Session::get('employer')['signup_fname']}}
                            </button>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="job-form">Post a Job</a></li>
                                <li><a class="dropdown-item" href="#">Applied Candidates</a></li>
        ...
        <main class="py-5 home" style="min-height: 80vh;">
            @yield('content')
        </main>
